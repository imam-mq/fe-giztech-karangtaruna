...
export default function TestimoniCTA() {
    const { ref, isVisible } = useReveal();

    return (
        <section ref={ref} className={`reveal ${isVisible ? "in" : ""} py-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto`}>
            <div className="bg-[#1E293B] rounded-[2rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 max-w-2xl mx-auto">
                    <h2 className="font-headline-lg text-headline-lg text-white mb-6">
                        Siap Jadi Klien Kami Berikutnya ?
                    </h2>
                    <p className="font-body-lg text-body-lg text-gray-300 mb-10">
                        Diskus proyek anda bersama tim kami 
                    </p>
